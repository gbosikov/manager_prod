...
urlpatterns = [
    ...
    path('new-department/', views.newDepartment, name='new-department'),
    ...
    path('show-task/<int:task_id>', views.show_task, name='show-task'),
    path('edit-task/<int:task_id>', views.edit_task, name='edit-task'),
    path('users/profile/<int:user_id>', views.show_person_tasks, name='users-task'),
]
